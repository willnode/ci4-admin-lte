      ...
      <div class="card my-3">
        <div class="row gutter-0">
          <div class="col-lg-4 p-4 d-flex flex-column justify-content-center">
            ...
            <div><a href="/login/" class="btn bg-gradient-navy">Sign In Here</a></div>
          </div>
            ...
            <div class="card">
              <div class="card-body">
                ...
                <?php foreach ($$cat as $item) : ?>
                  ...
                  <hr>
                <?php endforeach ?>
                <div class="mt-3"><a href="/category/<?= $cat ?>/" class="btn bg-gradient-navy">More <?= ucfirst($cat) ?></a></div>
              </div>
            </div>
          </div>
        <?php endforeach ?>
      ...
      <div class="card mb-3">
        <div class="card-body">
          ...
          <div class="d-flex flex-wrap">
            <?php foreach ([
              'blue', 'indigo', 'purple', 'pink', 'red', 'orange', 'yellow', 'purple', 'green',
              'teal', 'cyan', 'white', 'gray', 'gray-dark', 'primary', 'secondary', 'success', 'info',
