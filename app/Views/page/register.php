...
<body class="text-center" style="background: url(https://images.unsplash.com/photo-1457694587812-e8bf29a43845?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1953&q=80) center/cover #104203; position: relative">
    <style>
        form {
            border-radius: 10px;
    ...
    <div class="justify-content-center container d-flex flex-column" style="min-height: 100vh; max-width: 476px">
        ...
        <form method="POST" name="loginForm" class="container shadow d-flex flex-column justify-content-center pb-1 pt-3 text-white">
            ...
            <input type="submit" value="Register" class="btn-success btn mb-3">
        ...
        <div class="floating">
            <small>
                <a href="https://unsplash.com/photos/8EzNkvLQosk" target="_blank" rel="noopener noreferrer">Background by Maarten van den Heuvel</a>
            </small>
        </div>
    </div>
